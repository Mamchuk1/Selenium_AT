...
export function email(driver) { return driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[3]/div[3]/div/form/div[1]/div/input")); }
export function password(driver) { return driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[3]/div[3]/div/form/div[2]/div[2]/input")); }
export function enter2(driver) { return driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[3]/div[3]/div/form/div[4]/div[2]/button")); }
export function capca(driver) { return driver.findElement(By.xpath("/html/body/div[1]/div[2]/div[3]/div[3]/div/form/div[3]/div/div/div/iframe")); }
...
export function balanceBuy(driver) {return driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/div/div[5]/div/div[2]/div[1]/div/p/span"));}
export function balanceSell(driver) {return driver.findElement(By.xpath("/html/body/div/div/div/div/div/div/div/div[5]/div/div[2]/div[2]/div/p/span"));}
...
export function wait_login_field(driver) { return driver.wait(until.elementLocated(By.xpath("/html/body/div[1]/div[2]/div/div[2]/div/div[3]/div[3]/div/form/div[1]/div/input")));}
